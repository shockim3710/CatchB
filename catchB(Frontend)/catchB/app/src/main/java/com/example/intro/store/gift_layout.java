...
public class gift_layout extends AppCompatActivity {
    ...
    public void StoreResponse() {
        ...
        call.enqueue(new Callback<MypageResponse>() {
            ...
            public void onFailure(Call<MypageResponse> call, Throwable t) {
                Log.d("불러오기", "실패");
                AlertDialog.Builder builder = new AlertDialog.Builder(gift_layout.this);
                builder.setTitle("알림")
    ...
    public void clickConvi(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, convi_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
    ...
    public void clickGifticon(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, gifticon_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
    ...
    public void clickEtc(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, etc_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
    ...
    public void clickStorage(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, storage_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
    ...
    public void clickStore(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, Store.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
    ...
    public void LogoClick(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, MainPage.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
    public void MypageClick(View view) {
        ...
        Intent intent2 = new Intent(gift_layout.this, MyPage.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        gift_layout.this.finish();
    }
