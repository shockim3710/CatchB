...
public class convi_layout extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.convi_layout);
    ...
    public void StoreResponse() {
        ...
        call.enqueue(new Callback<MypageResponse>() {
            ...
            public void onFailure(Call<MypageResponse> call, Throwable t) {
                Log.d("불러오기", "실패");
                AlertDialog.Builder builder = new AlertDialog.Builder(convi_layout.this);
                builder.setTitle("알림")
    ...
    //------------------------------인텐트--------------------------------------------------
    public void purchase_check(View view){
        Intent intent = getIntent();
        String userid = intent.getStringExtra("user_id");

        Intent intent2 = new Intent(convi_layout.this, purchase_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    ...
    public void clickGift(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, gift_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    ...
    public void clickGifticon(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, gifticon_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    ...
    public void clickEtc(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, etc_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    ...
    public void clickStorage(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, storage_layout.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    ...
    public void clickStore(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, Store.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    ...
    public void LogoClick(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, MainPage.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
    public void MypageClick(View view) {
        ...
        Intent intent2 = new Intent(convi_layout.this, MyPage.class);
        intent2.putExtra("user_id", userid);
        startActivity(intent2);
        convi_layout.this.finish();
    }
